...
- E0 through E4 are complete. `tui-010-prove-shell-composition`,
  ...
  complete, TUI-030 through TUI-040 are complete, and TUI-050 through TUI-056
  are complete. TUI-057 is the only pending canonical task, and all later TUI
...
- The 2026-09-02 cross-machine evaluation portability maintenance is complete:
  ...
  reconciled, and TUI-057 remains the only pending canonical task.
...
- [x] TUI-051 implementation — moved Tasks into the shared overlay with local
  selection/notices, stable refresh identity, callback parity, and exact source
  return. Its completion handoff published only TUI-052.
- [x] TUI-052 implementation — moved Runs and Run Detail into one explicit
...
- [x] TUI-054 implementation — moved Workflow into the shared overlay while
  retaining its controls, live updates, needs-input state, and rollback page.
  Its completion handoff published only TUI-055.
- [x] TUI-055 implementation — moved Change Summary into the shared overlay
  while retaining its metadata/evidence distinction, refresh, scrolling, and
  rollback page.
  Its completion handoff published only TUI-056.
- [x] TUI-056 implementation — moved Evidence into the shared overlay while
  retaining provenance, refresh, scrolling, validation routes, and the
  rollback page.
  Its completion handoff published only TUI-057.
- [ ] TUI-057 implementation — move Approval into the shared overlay while
  retaining exact request identity, explicit confirmation, refusal, refresh,
