...
- Implementation status: E0 through E4 and TUI-050 through TUI-054 are
  complete; TUI-055 is the only pending canonical task, and later tasks remain
  unpublished drafts
...
completion handoff. TUI-010 through TUI-054 are complete and TUI-055 is the
...
TUI-010 through TUI-054 are complete. TUI-054's completion handoff published
only [TUI-055](tasks/tui-055-move-change-summary-overlay.md); every later TUI task
